...
const normalizedProjection = (text) => {
...
export const sanitizeConversationSnapshot = (snapshot) => {
    ...
    for (const notice of [credentialsRedacted ? CREDENTIAL_NOTICE : undefined, controlsRemoved ? CONTROL_NOTICE : undefined]) {
        if (notice !== undefined && !notices.includes(notice))
            notices.push(notice);
    }
    return {
        ...snapshot,
...
//# sourceMappingURL=conversation-sanitization.js.map