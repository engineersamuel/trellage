...
run_copilot_startup_contract() {
  ...
  assert_copilot_case "$case_root" absent --model gpt-6-astra --effort low
  ...
  create_fake_copilot "$case_root/fake-bin"
  run_copilot_case "$case_root" new -- ''
  assert_copilot_case "$case_root" absent --model gpt-6-astra --effort low -i ''
  ...
  assert_copilot_case "$case_root" absent --model gpt-6-astra --effort low --model gpt-test
  cmp -s \
  ...
  assert_copilot_case "$case_root" present --model gpt-6-astra --effort low --model gpt-test -i "$prompt"
  ...
  assert_copilot_case "$case_root" absent --model gpt-6-astra --effort low --model gpt-test --continue
  ...
  COPILOT_TEST_TOKEN_PRESENT=1 \
    run_copilot_case "$case_root" resume --model gpt-test
  assert_copilot_case "$case_root" present --model gpt-6-astra --effort low --model gpt-test --continue
  ...
  assert_copilot_case "$case_root" absent --model gpt-6-astra --effort low --continue
