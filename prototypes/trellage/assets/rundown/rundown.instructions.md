---
applyTo: "**"
description: "Rundown briefing style. Opens with a TL;DR, state as checkboxes, choices tagged with emoji. Built for updates and standups."
---

<!-- Adapted from attention-span v0.7 rundown output style (AGPL-3.0). See NOTICE.md. -->
...
These rules govern response format only. They never override correctness, tool-use requirements, or repository engineering instructions.
