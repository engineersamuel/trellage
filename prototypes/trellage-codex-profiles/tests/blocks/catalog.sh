...
mutate_catalog changed-pstack-kind-field '.profiles.pstack.kind = "skills"'
mutate_catalog changed-pstack-bundles '.profiles.pstack.skillBundles = ["youtube"]'
...
mutate_catalog changed-youtube-kind '.profiles.youtube.kind = "plugin"'
mutate_catalog changed-youtube-source '.profiles.youtube.source = "other/youtube-skills"'
mutate_catalog changed-youtube-bundles '.profiles.youtube.skillBundles = ["native-common"]'
mutate_catalog changed-youtube-managed-skills '.profiles.youtube.managedSkills = ["transcript"]'
mutate_catalog changed-youtube-required-environment '.profiles.youtube.requiredEnvironment = []'
mutate_catalog changed-youtube-plugin '.profiles.youtube.plugin = "youtube-skills"'
